 ...
 * del usuario: "que le indique... que lo oscuro es peligroso". */
export function MapLegend() {
  const metrica = useAppStore((s) => s.metrica);
  const titulo = metrica === "TASA" ? "Tasa x100k hab." : "Densidad Delictiva";

  return (
    <div className="absolute bottom-[288px] left-4 rounded-lg border border-border bg-surface-panel/80 backdrop-blur-md px-4 py-3 shadow-lg">
