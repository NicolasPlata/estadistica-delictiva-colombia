...
- [x] **Fase 3: Desarrollo del Backend en Rust** (**100% completa** — Fundaciones, Modelado, Motor Analítico, Motor Geoespacial y Refinamiento/Performance) — detalle de Hitos en [`docs/plans/02-plan-desarrollo-backend.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/docs/plans/02-plan-desarrollo-backend.md), progreso granular en [`BACKLOG.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/BACKLOG.md).
- [x] **Fase 4: Desarrollo del Frontend en React** (**100% completa** — Setup, Layout/Filtros, Cartografía, Dashboarding, Integración/Optimización) — detalle de Hitos en [`docs/plans/03-plan-desarrollo-frontend.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/docs/plans/03-plan-desarrollo-frontend.md), progreso granular en [`BACKLOG.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/BACKLOG.md).
- [ ] **Fase 5: Despliegue e Integración Final** 📍 *(<- ESTAMOS AQUÍ)* (Pendiente — único punto abierto de toda la hoja de ruta)
- [x] **Fase 6: Tasa de Criminalidad per Cápita** (Completa — ETL de población DANE, backend con `metrica` ABSOLUTA/TASA, toggle en frontend, control "Ver Por" en Figma, verificado end-to-end contra datos reales) — detalle en [`docs/plans/04-plan-desarrollo-funcionalidades-v2.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/docs/plans/04-plan-desarrollo-funcionalidades-v2.md), progreso granular en [`BACKLOG.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/BACKLOG.md).
- [x] **Fase 7: Desglose de Delitos por Región (Tabla + Pastel)** (Completa — taxonomía de 8 categorías auditada contra los 47 delitos reales, endpoint `/stats/breakdown`, panel con tabla + donut en el frontend, paleta categórica en Figma, verificado end-to-end con datos reales) — detalle en [`docs/plans/04-plan-desarrollo-funcionalidades-v2.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/docs/plans/04-plan-desarrollo-funcionalidades-v2.md), progreso granular en [`BACKLOG.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/BACKLOG.md).
- [x] **Fase 8: Leyenda del Mapa** (Completa — corregida la dirección del degradado desincronizada, labels y línea explícita "Más oscuro = más peligroso" agregados, propagado automáticamente a las 6 instancias ya existentes en Figma, componente nuevo en el frontend con título dinámico según métrica, verificado en ambos temas) — detalle en [`docs/plans/04-plan-desarrollo-funcionalidades-v2.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/docs/plans/04-plan-desarrollo-funcionalidades-v2.md), progreso granular en [`BACKLOG.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/BACKLOG.md).

**`docs/plans/04-plan-desarrollo-funcionalidades-v2.md` completo** (Fases 6-8) — las 3 funcionalidades pedidas por el usuario el 2026-08-07 están implementadas, verificadas con datos reales end-to-end y documentadas. Solo queda la Fase 5 (despliegue) de toda la hoja de ruta.

*(Se abandona la numeración detallada de Hitos 3.1-3.5 que vivía aquí — ya no coincidía con la estructura real de `docs/plans/02-...`. Ese documento y `BACKLOG.md` son ahora la única fuente de verdad para el detalle, evitando que este tracker se desactualice de nuevo. Fases 6-8 se están implementando antes que la Fase 5 (despliegue) por decisión explícita del usuario — no bloquean ni dependen de ella.)*
