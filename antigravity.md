...
- [ ] **Fase 6: Tasa de Criminalidad per Cápita** 📍 *(<- ESTAMOS AQUÍ, en curso)* — Hitos 6.1-6.3 (ETL de población DANE, esquema `poblacion_municipal`, reglas de negocio RN-11/12/13) completos; faltan 6.4-6.7 (backend, frontend, Figma, verificación). Detalle en [`docs/plans/04-plan-desarrollo-funcionalidades-v2.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/docs/plans/04-plan-desarrollo-funcionalidades-v2.md), progreso granular en [`BACKLOG.md`](file:///home/nicolas/Personal_Projects/New%20Estadistica%20Delictiva/BACKLOG.md).
