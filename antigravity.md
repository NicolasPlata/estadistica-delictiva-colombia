...
- [ ] **Fase 7: Desglose de Delitos por Región (Tabla + Pastel)** 📍 *(<- ESTAMOS AQUÍ)* (Pendiente, sin iniciar — bloqueada por la taxonomía de categorías de delitos, decisión pendiente del usuario en `BACKLOG.md`)
- [ ] **Fase 7: Desglose de Delitos por Región (Tabla + Pastel)** (Pendiente, sin iniciar)
- [ ] **Fase 8: Leyenda del Mapa** (Pendiente, sin iniciar)
